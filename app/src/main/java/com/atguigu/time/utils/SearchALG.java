...
public class SearchALG {
     ...
     * @return
     */
    public static boolean isAddToHintList(String hint_data, String changedText) {
     ...
     * @return
     */
    private static boolean isAcronymEquals(String hint_data, String changedText) {
        boolean result = true;
        String hintFirst;
        ...
        for (int i = 0; i < changedText.length() && isEquals; i++) {
            if(startIndex>=hint_data.length()) {
                isEquals=false;
                result=false;
                break;
            }
     ...
     * @return
     */
    private static String getFirstCharacter(String data) {
        characterParser = CharacterParser.getInstance();
        String result = "";
